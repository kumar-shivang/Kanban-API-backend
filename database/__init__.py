# This file is the intialized file for the database folder. It is used to initialize the database object. It is imported in the card.model.py and list.model.py files. It is also imported in the app.py file.
from flask_sqlalchemy import SQLAlchemy
from werkzeug.security import generate_password_hash, check_password_hash
from datetime import datetime,  timedelta   # Import the datetime object from the datetime module.
...
class User(db.Model):
    ...
    email = db.Column(db.String(50),
                      unique=True,nullable=True)  # email is unique. It has 50 characters because it is a optimum number of characters for an email address.
    #userLists = db.relationship('List', backref='user')  # userLists is a relationship field that references the List class. It is used to get all the lists for a user.
    #userCards = db.relationship('Card', backref='user')  # userCards is a relationship field that references the Card class. It is used to get all the cards for a user.
